...
st.title("💬 Анализ тональности комментариев (VK + YouTube)")
...
if st.session_state["summary_df"] is not None:
    ...
    totals = {
        "Позитив": (round(100 * counts.get("Позитив", 0) / total, 1), counts.get("Позитив", 0), "mediumseagreen"),
    ...
    fig = px.pie(
        ...
        color="Тональность", color_discrete_map={"Позитив":"mediumseagreen","Нейтрал":"gold","Негатив":"indianred"},
    ...
    fig2 = px.bar(
        ...
        color_discrete_map={"Позитив":"mediumseagreen","Нейтрал":"gold","Негатив":"indianred"},
